...
const SearchBooking = () => {
    ...
    useEffect(() => {
        const getSearch = async () =>{
            ...
            const result = await webApi.searchAdmin(getType.Booking, params);
    ...
    if(loading){
        ...
        if(listBooking){
            viewDisplay = 
                    <tr onClick={() => showModal(listBooking.id)}>
                        <td>{listBooking.id}</td>
                        <td>{listBooking.user.id}</td>
                        <td>{listBooking.count}</td>
                        <td>
                        <NumericFormat value={listBooking.price}  displayType={"text"} thousandSeparator={','} suffix={' vnd'}/>
                        </td>
                        <td>{listBooking.date}</td>
    ...
    return (
        <div className="ListBooking-page">
            ...
            {listBooking ? (<DetailBooking data={listBooking} payload={payload} setPayload={setPayload}/> ) : ''}
        </div>
    )
}
